    ...
    post {
        always {
            script {
                ...
                def extentReportPath = ${file.path}
                def extentReportHtml = readFile file: extentReportPath
                ...
                def emailBody = """
                   <br><hr><br>  
                    ...
                    <br><br>
    				<h4>Extent Report: </h4> 📊<a href="${env.BUILD_URL}artifact/${extentReportPath}">View Full Extent Report</a>
    				<br><br>
            ...
            archiveArtifacts artifacts: '${extentReportPath}', fingerprint: true
            }
        }
    }
}
